<%-- 
    Document   : viewcollar
    Created on : Dec 20, 2019, 9:36:37 PM
...
<div id="center">
<h1 class="cata" style="text-align: center; margin-top: 30px;">LIST OF ALL COLLARS</h1>
...
String sql ="select * from products WHERE Type = 'Collar'";
