<%-- 
    Document   : viewcloth
    Created on : Dec 20, 2019, 2:45:25 PM
...
<div id="center">
<h1 class="cata" style="text-align: center; margin-top: 30px;">LIST OF ALL CLOTHES</h1>
...
String sql ="select * from products WHERE Type = 'Cloth'";
